  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showCloseButton ? (
          <SheetPrimitive.Close className="absolute right-4 top-4 rounded-base border-2 border-border focus:outline-none focus-visible:border-main disabled:pointer-events-none">
            <X className="h-4 w-4" />
